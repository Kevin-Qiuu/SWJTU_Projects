...
if __name__ == '__main__':
    ...
    # 视频保存路径
    video_path = f'F://camera//camera_save//{int(time.time())}.mp4'
    video_depth_path = f'F://camera//camera_save//{int(time.time())}_depth.mp4'
    video_depthcolor_path = f'F://camera//camera_save//{int(time.time())}_depthcolor.mp4'
    video_depthcolor_camera_path = f'F://camera//camera_save//{int(time.time())}_depthcolor.mp4'
    # 初始化参数
    fps, w, h = 30, 1280, 720
